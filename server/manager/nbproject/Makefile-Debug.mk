...
# CC Compiler Flags
CCFLAGS=-pthread -fprofile-arcs -ftest-coverage
CXXFLAGS=-pthread -fprofile-arcs -ftest-coverage
...
${OBJECTDIR}/startSocket.o: startSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -include lib/mysql-connector/include/mysql_connection.h -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/startSocket.o startSocket.cpp
...
${TESTDIR}/tests/newtestclass1.o: tests/newtestclass1.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -include lib/mysql-connector/include/mysql_connection.h -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestclass1.o tests/newtestclass1.cpp


${TESTDIR}/tests/newtestrunner1.o: tests/newtestrunner1.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -include lib/mysql-connector/include/mysql_connection.h -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestrunner1.o tests/newtestrunner1.cpp
...
${OBJECTDIR}/startSocket_nomain.o: ${OBJECTDIR}/startSocket.o startSocket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -include lib/mysql-connector/include/mysql_connection.h -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/startSocket_nomain.o startSocket.cpp;\
	else  \
