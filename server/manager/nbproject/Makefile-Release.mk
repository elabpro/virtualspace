...
${OBJECTDIR}/CheckSuccessfullPerformanceCommand.o: CheckSuccessfullPerformanceCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CheckSuccessfullPerformanceCommand.o CheckSuccessfullPerformanceCommand.cpp
...
${OBJECTDIR}/ManagerSocket.o: ManagerSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ManagerSocket.o ManagerSocket.cpp

${OBJECTDIR}/SequenceTreatmenter.o: SequenceTreatmenter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SequenceTreatmenter.o SequenceTreatmenter.cpp
...
${OBJECTDIR}/startSocket.o: startSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/startSocket.o startSocket.cpp
...
${OBJECTDIR}/CheckSuccessfullPerformanceCommand_nomain.o: ${OBJECTDIR}/CheckSuccessfullPerformanceCommand.o CheckSuccessfullPerformanceCommand.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CheckSuccessfullPerformanceCommand_nomain.o CheckSuccessfullPerformanceCommand.cpp;\
	else  \
...
${OBJECTDIR}/ManagerSocket_nomain.o: ${OBJECTDIR}/ManagerSocket.o ManagerSocket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ManagerSocket_nomain.o ManagerSocket.cpp;\
	else  \
...
${OBJECTDIR}/SequenceTreatmenter_nomain.o: ${OBJECTDIR}/SequenceTreatmenter.o SequenceTreatmenter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SequenceTreatmenter_nomain.o SequenceTreatmenter.cpp;\
	else  \
...
${OBJECTDIR}/startSocket_nomain.o: ${OBJECTDIR}/startSocket.o startSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/startSocket.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/startSocket_nomain.o startSocket.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/startSocket.o ${OBJECTDIR}/startSocket_nomain.o;\
	fi
